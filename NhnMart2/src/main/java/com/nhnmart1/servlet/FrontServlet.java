...
//        String processingServletPath = null;
        ...
        if ("/mart/foodStandForm.do".equals(servletPath)) {
            command = new FoodStandFormController();
        } else if ("/mart/foodView.do".equals(servletPath)) {
            command = new FoodViewServlet();
        }
//        else if ("/mart/cart.do".equals(servletPath)) {
//            command = new CartServlet();
//        }
        return command;
    }
}
